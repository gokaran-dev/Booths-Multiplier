...
HD_PWD='D:/Mtech/Vivado/Booths Multiplier/Booths Multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Booths_Multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Booths_Multiplier.tcl -notrace
