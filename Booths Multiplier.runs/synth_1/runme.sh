...
HD_PWD='D:/Mtech/Vivado/Booths Multiplier/Booths Multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Booths_Multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Booths_Multiplier.tcl
